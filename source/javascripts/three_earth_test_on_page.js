...
function init()
{
	...
	// SKYBOX/FOG
	var materialArray = [];
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../images/stemkowski/dawnmountain-xpos.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../images/stemkowski/dawnmountain-xneg.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../images/stemkowski/dawnmountain-ypos.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../images/stemkowski/dawnmountain-yneg.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../images/stemkowski/dawnmountain-zpos.png' ) }));
	materialArray.push(new THREE.MeshBasicMaterial( { map: THREE.ImageUtils.loadTexture( '../images/stemkowski/dawnmountain-zneg.png' ) }));
	for (var i = 0; i < 6; i++)
	...
	var floorTexture = new THREE.ImageUtils.loadTexture( '../images/stemkowski/checkerboard.jpg' );
	...
	var crateTexture = new THREE.ImageUtils.loadTexture( '../images/stemkowski/crate.gif' );
